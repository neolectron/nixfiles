...
| Judge-supplied standalone JAR | Blind input without an accompanying application suite | Mapping and generated JAR reproduced byte-for-byte |
...
### Judge-supplied standalone candidate

On 2026-08-18, the judges supplied a standalone `bitwig.jar` without a Linux
package or application tree. It was treated as a blind candidate and copied to
the ignored local path `assets/bitwig/candidates/6.0.11/bitwig.jar`; neither
the patch specification nor Java sources were changed before testing it.

| Artifact | SHA-256 |
| --- | --- |
| Supplied candidate JAR | `3971ce118701ed3a60603ae5cec134b52dcaf88178c0e1d1a6b040be85acf229` |
| Generated resolved map | `40ac30803daeb3bc31ea10890195562768e6b8be3c78999eae51f076e5216c0c` |
| Generated candidate JAR | `b71be9c1f8d733ae3869a68447188b3499dae1700e7fca6115a5c035d0d59946` |

The resolver recovered all eight target classes and three transformation
roles, and the transformer completed without fallback or manual symbol input.
The supplied JAR is byte-identical to the previously hash-pinned official
6.0.11 target, while the generated JAR is byte-identical to the 6.0.11 JAR
already launched successfully from the system desktop entry. This is therefore
a conclusive blind-provenance and standalone-input test, but it is not claimed
as an additional release or a new symbol-map data point.
